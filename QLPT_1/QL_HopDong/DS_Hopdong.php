    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
        ...
        <div class="row" >
            ...
            <div class="panel-body" >
                ...
                <!-- END BIỂU ĐỒ-->
        <!-- START SEARCH-->
                   <h1 style="font-size: 40px; text-align: center;">DANH SÁCH HỢP ĐỒNG</h1>
                    <!-- Start Table-->
                    <table 
                        ...
                        <?php  
                            ...
                            <tr>
                                ...
                                <td class="form-group">
                                    ...
                                    <a href="del_hdong.php?MaHD=<?php echo $row['MaHopDong'];?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                </td>
                            </tr>
                            <?php  } ?>                          
                        </tbody>
